...
/* Comments
The following changes needed to be made to fix the deadlock: 
1) Remove the "omp barrier" statement at the end of the "print_results" 
subroutine beacuse the subroutine is called within both sections, so it will 
never end if the barrier statement exitst
*/
